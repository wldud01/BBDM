...
class LatentBrownianBridgeModel(BrownianBridgeModel):
    def __init__(self, model_config):
        ...
        # VQGAN Model channel 관련
        self.input_adapter = nn.Conv2d(2, 3, kernel_size=1)
        self.output_adapter = nn.Conv2d(3, 1, kernel_size=1)
    ...
    def encode(self, x, cond=True, normalize=None):
        ...
        # VQGAN checkpoint 사용 시, input channel이 맞지 않아 임시로 3채널로 변환
    ...
    def decode(self, x_latent, cond=True, normalize=None):
        ...
        # VQ GAN checkpoint 사용 시, output channel이 맞지 않아 임시로 3 -> 1채널로 변환
